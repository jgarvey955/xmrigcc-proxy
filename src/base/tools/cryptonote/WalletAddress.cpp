...
const xmrig::WalletAddress::TagInfo &xmrig::WalletAddress::tagInfo(uint64_t tag)
{
    ...
    static const std::map<uint64_t, TagInfo> tags = {
        ...
        { 0x180c96,     { Coin::SALVIUM,      MAINNET,    PUBLIC,         19081,  19082 } }, // Carrot
        { 0x2ccc96,     { Coin::SALVIUM,      MAINNET,    INTEGRATED,     19081,  19082 } }, // Carrot integrated
        { 0x314c96,     { Coin::SALVIUM,      MAINNET,    SUBADDRESS,     19081,  19082 } }, // Carrot subaddress
        ...
        { 0x254c96,     { Coin::SALVIUM,      TESTNET,    PUBLIC,         29081,  29082 } }, // Carrot
        { 0x1ac50c96,   { Coin::SALVIUM,      TESTNET,    INTEGRATED,     29081,  29082 } }, // Carrot integrated
        { 0x3c54c96,    { Coin::SALVIUM,      TESTNET,    SUBADDRESS,     29081,  29082 } }, // Carrot subaddress
        ...
        { 0x24cc96,     { Coin::SALVIUM,      STAGENET,   PUBLIC,         39081,  39082 } }, // Carrot
        { 0x1a848c96,   { Coin::SALVIUM,      STAGENET,   INTEGRATED,     39081,  39082 } }, // Carrot integrated
        { 0x384cc96,    { Coin::SALVIUM,      STAGENET,   SUBADDRESS,     39081,  39082 } }, // Carrot subaddress
